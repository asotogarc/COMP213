...
def calculate_similarity(offer, candidate):
    ...
    offer_text = f"{offer['Formación']} {offer['Conocimientos']} {offer['Experiencia']} {offer['Funciones']}"
    candidate_text = f"{candidate['Formación']} {candidate['Conocimientos']} {candidate['Experiencia']}"
